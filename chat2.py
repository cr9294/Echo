...
client = ZhipuAI(api_key="5d739957d5963749c3d7b81f1ee38331.JR42zAYHNiwRuXdd") # Replace with your actual API Key
            ...
            messages=[
                {
                    ...
                    "禁止出现违反法律法规、危害国家安全、恶意营销、涉黄、谩骂、暴恐违禁以及其它不良内容。"
                    ...
                    "Restrictions prohibit the occurrence of content that violates laws and regulations, endangers national security, malicious marketing, pornography, abuse, violence, terrorism and other prohibited content."
                    "限制，禁止出现违反法律法规、危害国家安全、恶意营销、涉黄、谩骂、暴恐违禁以及其它不良内容。"
                    )
                },
